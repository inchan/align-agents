...
async function runTests() {
    ...
    assert(createSetResponse.status === 200, 'Status 200');
    assert(createSetResponse.data && createSetResponse.data.id, 'Set created with ID');
    const setId = createSetResponse.data.id;
    ...
    assert(updateRuleResponse.status === 200, 'Status 200');
